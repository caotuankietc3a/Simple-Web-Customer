	...
	<div class="container mt-4">
		<h1 class="display-4 text-center">
			<i class="fas fa-book-open text-primary"></i> My<span
				class="text-primary">Customer</span>List
		</h1>
			...
			<tbody class="text-center">
				<c:forEach var="customer" items="${customers}">
					...
					<tr>
						...
						<td><a class="btn btn-danger btn-sm" href="${deleteLink}">X</a></td>
		...
		<div>
			<a href="<c:url value="/customer-form"/>"><input
				class="btn btn-primary btn-block mt-2" value="Add Customer"></input></a>
		</div>
	</div>
</body>
</html>
